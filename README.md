...
**Запуск системы.** Доступ к веб-сервису **X-Check App** осуществляется интерактивно через сеть Интернет посредством обращения по адресу: **[ссылка](https://super-x-check-app.netlify.app/)**.
...
- Export / Import как одной так и нескольких задач (собственный формат | формат RSS | **MARKDOWN** )
...
- Есть возможность поставить дополнительный балл и оставить коментарий за что (можно и отрицательный)
